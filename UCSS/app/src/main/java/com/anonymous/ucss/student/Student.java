...
//            super.onBackPressed();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_stu_int) {
            ...
            intent.putExtra(Config.table, "Internals");
            ...
            intent.putExtra(Config.login_id,username);
            intent.putExtra(Config.WHO, who);
            intent.putExtra(Config.table, "Attendance");
            startActivity(intent);
        ...
        } else if (id == R.id.nav_way2sms) {
            Intent intent = new Intent(Student.this,stu_sms.class);
            startActivity(intent);
